...
public final class ActivityDonasiPembayaranSuksesBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityDonasiPembayaranSuksesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDonasiPembayaranSuksesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_donasi_pembayaran_sukses, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
