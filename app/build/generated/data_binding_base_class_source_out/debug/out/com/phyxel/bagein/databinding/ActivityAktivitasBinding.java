...
public final class ActivityAktivitasBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAktivitasBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityAktivitasBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAktivitasBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_aktivitas, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAktivitasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAktivitasBinding((ConstraintLayout) rootView, aktivitas, aktivitasMisi,
